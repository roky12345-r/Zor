...
TELEGRAM_BOT_TOKEN = '7805207112:AAHBDITsw7LVuQ7u9xBHXKhI6Ek50_wg388'
ADMIN_USER_ID = 1228841884  
...
print(f"Running: ./LEGEND {ip} {port} {duration}")
...
def main():
    ...
    application.add_handler(CommandHandler("help", help_command))  # <--- This was missing
